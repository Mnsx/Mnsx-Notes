...
* **互斥锁**
  ...
  * **互斥锁的销毁**
  ...
  int main() {
      ...
      pthread_create(&thread1, NULL, spend, (void *)data);
  
      pthread_create(&thread2, NULL, doubleSpend, (void *)data);
...
* **条件变量**
  ...
  **等待线程通常需要循环检查条件**
  ...
  int main() {
      ...
      pthread_create(&thread1, NULL, a, (void *)&ready);
      pthread_create(&thread2, NULL, b, (void *)&ready);
      pthread_create(&thread3, NULL, c, (void *)&ready);
